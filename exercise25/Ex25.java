...
public class Ex25{
    public static void run(){
        ...
        calcularNota.media();;
        System.out.println("A nota ponderada do aluno "+name+" de matricula "+matricula+"; é de "+String.format("%.2f",calcularNota.media)+" e sua classificação é: "+calcularNota.classificacao);
        input.close();
    }
}